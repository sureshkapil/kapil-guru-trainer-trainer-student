package com.kapilguru.trainer.student.homeActivity.studentStudyMaterialFragment
...
import kotlinx.android.synthetic.main.student_fragment_study_material.view.*


class StudentStudyMaterialFragment : Fragment(), PopularAndTrendingAdapter.CardItem {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.student_fragment_study_material, container, false)
    }
...
*/
    ...
    private fun setUpRecycler(view: View) {
        ...
        view.studyMaterialRecy.layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.HORIZONTAL, false)
        view.studyMaterialRecy.adapter  = adapter
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = StudentStudyMaterialFragment()
    }
}