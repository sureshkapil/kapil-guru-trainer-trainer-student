...
import com.kapilguru.trainer.student.announcement.inbox.view.InboxList
import com.kapilguru.trainer.student.announcement.newMessage.StudentNewMessageFragment
import com.kapilguru.trainer.student.announcement.sentItems.StudentSentItemsFragment

class StudentAnnouncementFragmentAdapter(fragmentManager: FragmentManager, lifecycle: Lifecycle) : FragmentStateAdapter(fragmentManager, lifecycle) {
    ...
    override fun createFragment(position: Int): Fragment {
        return when (position) {
            0 -> StudentNewMessageFragment()
            1 -> InboxList()
            else -> StudentSentItemsFragment()
        }
    }
