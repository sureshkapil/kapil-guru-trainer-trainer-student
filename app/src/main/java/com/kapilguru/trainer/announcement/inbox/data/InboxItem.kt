...
data class InboxItem(
    ...
    fun getCreatedTime() : String{
        val indexOfTimeStart = createdDate.indexOf("T")
        Log.d(TAG,"getCreatedTime indexOfTimeStart : "+indexOfTimeStart)
        val indexofTimeEnding = createdDate.length - createdDate.indexOf(".000z",0,true)
        Log.d(TAG,"getCreatedTime time Length : "+createdDate.length)
        Log.d(TAG,"getCreatedTime index of 000z : "+createdDate.indexOf(".000z",0,true))
//        var time = createdDate.substring(indexOfTimeStart,indexofTimeEnding)
//        Log.d(TAG,"getCreatedTime indexofTimeEnding : "+indexofTimeEnding)
        return createdDate.substring(11,19)
}
