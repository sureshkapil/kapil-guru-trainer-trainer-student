...
public class RichText extends WebView {
    ...
    public void setFontSize(int fontSize) {
        if (fontSize > 7 || fontSize < 1) {
            Log.e("RichText", "Font size should have a value between 1-7");
        }
    ...
    /**
     * {@link RichText#insertImage(String, String)} will show the original size of the image.
