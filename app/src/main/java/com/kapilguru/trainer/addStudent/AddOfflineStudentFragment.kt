 ...
 */
class AddOfflineStudentFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AddOfflineStudentFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) = AddOfflineStudentFragment().apply {
