...
import com.kapilguru.trainer.allSubscription.subscriptions.SubscriptionsFragment

class SubscriptionsFragmentAdapter(fragmentManager: FragmentManager, lifecycle: Lifecycle) :
    FragmentStateAdapter(fragmentManager, lifecycle) {

    var titles = arrayListOf("SUBSCRIPTIONS", "My SUBSCRIPTIONS")
